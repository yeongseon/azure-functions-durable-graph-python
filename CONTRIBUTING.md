...
- Keep one representative example for the minimal Durable Functions graph workflow.
- Keep one complex example for multi-step orchestration and error handling.
